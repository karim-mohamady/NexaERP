...
export const modules: ModuleConfig[] = [
  ...
  { key: 'purchase-invoices', label: 'Purchase Invoices', endpoint: '/purchase-invoices', permission: 'purchases.view', icon: Receipt, columns: ['number', 'supplier_id', 'invoice_date', 'status', 'grand_total', 'paid_total'], fields: [{ name: 'supplier_id', label: 'Supplier ID', type: 'number' }, { name: 'number', label: 'Number' }, { name: 'invoice_date', label: 'Invoice date', type: 'date' }, { name: 'status', label: 'Status' }, { name: 'grand_total', label: 'Grand total', type: 'number' }] },
  { key: 'quotations', label: 'Quotations', endpoint: '/quotations', permission: 'sales.view', icon: FileText, columns: ['number', 'customer_id', 'quote_date', 'valid_until', 'status', 'grand_total'], fields: [{ name: 'customer_id', label: 'Customer ID', type: 'number' }, { name: 'number', label: 'Number' }, { name: 'quote_date', label: 'Quote date', type: 'date' }, { name: 'valid_until', label: 'Valid until', type: 'date' }, { name: 'status', label: 'Status' }, { name: 'grand_total', label: 'Grand total', type: 'number' }] },
  { key: 'sales-orders', label: 'Sales Orders', endpoint: '/sales-orders', permission: 'sales.view', icon: FileText, columns: ['number', 'customer_id', 'order_date', 'status', 'grand_total'], fields: [{ name: 'customer_id', label: 'Customer ID', type: 'number' }, { name: 'number', label: 'Number' }, { name: 'order_date', label: 'Order date', type: 'date' }, { name: 'status', label: 'Status' }, { name: 'grand_total', label: 'Grand total', type: 'number' }] },
  ...
  { key: 'companies', label: 'Companies', endpoint: '/companies', permission: 'settings.update', icon: Building2, columns: ['name', 'legal_name', 'email', 'phone', 'currency'], fields: [{ name: 'name', label: 'Name' }, { name: 'legal_name', label: 'Legal name' }, { name: 'email', label: 'Email', type: 'email' }, { name: 'phone', label: 'Phone' }, { name: 'currency', label: 'Currency' }] },
  { key: 'branches', label: 'Branches', endpoint: '/branches', permission: 'settings.update', icon: Building2, columns: ['name', 'code', 'city', 'country', 'is_active'], fields: [{ name: 'name', label: 'Name' }, { name: 'code', label: 'Code' }, { name: 'city', label: 'City' }, { name: 'country', label: 'Country' }] },
  { key: 'departments', label: 'Departments', endpoint: '/departments', permission: 'hr.view', icon: UserRoundCog, columns: ['name', 'description'], fields: [{ name: 'name', label: 'Name' }, { name: 'description', label: 'Description' }] },
  { key: 'job-titles', label: 'Job Titles', endpoint: '/job-titles', permission: 'hr.view', icon: UserRoundCog, columns: ['title'], fields: [{ name: 'title', label: 'Title' }] },
]
