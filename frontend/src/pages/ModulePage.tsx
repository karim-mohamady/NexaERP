  ...
  return (
    <div className="space-y-5">
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex gap-2"><button onClick={() => window.print()} className="grid size-10 place-items-center rounded-md border border-slate-200 dark:border-slate-800" aria-label="Print"><Printer size={18} /></button><button onClick={() => setFormOpen(true)} className="flex items-center gap-2 rounded-md bg-slate-950 px-4 py-2 text-white dark:bg-cyan-400 dark:text-slate-950"><Plus size={18} />{t(lang, 'create')}</button></div>
      </div>
